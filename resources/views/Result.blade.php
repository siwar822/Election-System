...
<div class="part">
<form id="" action="{{ route('datee') }}" method="POST">
        @csrf
       
<label for="">Choose the deadline date</label>



<input type="date" name="deadline"  class="form-control" value="{{ $dat}}" placeholder="Enter your birth date" >
